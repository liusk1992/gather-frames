 ...
 * 
 * @author liusk
 * @version $Id: ShiroConfig.java, v 0.1 2017年10月27日 下午2:56:49 liusk Exp $
 */
@Configuration
public class ShiroConfig {
    ...
    public ShiroFilterFactoryBean shiroFilterFactoryBean() {
        ...
        filterChainDefinitionManager.put("/user/**", "authc,roles[abcdefg]");//用户为ROLE_USER 角色可以访问。由用户角色控制用户行为。
