...
import org.liusk.payment.baofu.common.http.HttpFormParameter;
import org.liusk.payment.baofu.common.http.HttpMethod;
import org.liusk.payment.baofu.common.http.HttpSendModel;
import org.liusk.payment.baofu.common.http.SimpleHttpClient;
import org.liusk.payment.baofu.common.http.SimpleHttpResponse;
        ...
        try {
            ...
            if (isRequestSuccess(statusCode)) {
                return new SimpleHttpResponse(statusCode,
                    EntityUtils.toString(response.getEntity(), getCharSet), null);
            } else {
                return new SimpleHttpResponse(statusCode, null,
